...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.contourProjectionBtn = QtWidgets.QPushButton(self.centralwidget)
        self.contourProjectionBtn.setGeometry(QtCore.QRect(170, 540, 75, 23))
        self.contourProjectionBtn.setObjectName("contourProjectionBtn")
        self.closeProjectorBtn = QtWidgets.QPushButton(self.centralwidget)
        self.closeProjectorBtn.setGeometry(QtCore.QRect(260, 650, 75, 23))
        self.closeProjectorBtn.setObjectName("closeProjectorBtn")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.contourProjectionBtn.setText(_translate("MainWindow", "轮廓投影"))
        self.closeProjectorBtn.setText(_translate("MainWindow", "关闭投影"))
