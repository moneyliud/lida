...
if __name__ == '__main__':
    ...
    base_image = None
    for path in paths:
        if not os.path.isdir(path) and path.startswith("cali"):
            ...
            base_image = cv2.imread(base_dir + "/" + path)
    ...
    calibrator.base_image = base_image
    calibrator.init(7, 7, camera_mtx=mtx, camera_dist=distort, offset_y=14000, cali_img_interval=10000, xy_num=xy_num)
